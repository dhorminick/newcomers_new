...
(function ($) {
  ...
  var ThemeBuilder = (function () {
    ...
    var magnificPopupImageView = function () {
      ...
      if (
        checkSelectorExistence(".popup-youtube, .popup-vimeo, .popup-gmaps")
      ) {
    ...
    var setDivSameHeight = function (container) {
      ...
      $(container).each(function () {
        ...
        if (firstElement != posTop) {
          for (
            currElement = 0;
            currElement < elementArray.length;
            currElement++
          ) {
          ...
          elementArray.push(element);
          maxHeight =
            maxHeight < element.height() ? element.height() : maxHeight;
        }
        for (
          currElement = 0;
          currElement < elementArray.length;
    ...
    var setFooterHeight = function () {
      ...
      if (windowSize > 1280) {
        jQuery(".footer-fixed > .page-wraper").css(
          "padding-bottom",
          footerHeight
        );
      }
    ...
    return {
      ...
      afterLoadThePage: function () {
        setBootstrapDropDown();
        setDivSameHeight(
          ".equal-height-container .equal-height-container-item"
        );
        setCounterUp();
        masonryLayout();
        manageLoader();
